 ...
 * @namespace Mist
 */
var Mist;!function(t){function n(t){return t.replace(/[A-Z]/g,function(t){return"-"+t.toLowerCase()})}var e=function(){function e(e){this.statement=e;var i=document.createElement("style"),r=document.createTextNode("");i.appendChild(r),document.head.appendChild(i),this.value=new t.Value([{}]),this.value.when(function(t){var r=t.map(function(t){var i=[];for(var r in t)i.push(n(r)+":"+t[r]);return e.selector()+"{"+i.join(";")+"}"});i.innerHTML=r.join("")})}return e.prototype.add=function(n,e){var i=this;return void 0===e&&(e=0),new t.Promise(function(r){var o=i.value.compose(function(o){var s=e>0?{}:o[0];for(var u in n)s[u]=n[u];if(e>0){o.push(s);var c=t.Frame.on(function(){return i.value.compose(function(t){var n=t.indexOf(s);return 0>n||t.splice(n,1),t})},e);c.then(r)}return o});e>0||o.then(r)})},e.prototype.get=function(){return this.value.composite},e.prototype.set=function(t){return this.value.compose(function(){var n={};for(var e in t)n[e]=t[e];return[n]})},e}();t.Style=e}(Mist||(Mist={}));/**
 * @copyright 2015 AI428
 * @description multi event, style accessor
 * @license http://opensource.org/licenses/MIT
 * @namespace Mist
 */
var Mist;!function(t){var n;!function(n){var e=function(){function n(n){this.emitter=n;var e=!1;!function(){var i=new t.Emission(n,"mousedown"),r=new t.Emission(n,"touchstart"),o=t.Promise.race([i,r]);o.when(function(t){n.emit("panstart",t),e=!0,i.resume(),r.resume()})}(),function(){var i=new t.Emission(n,"mousemove"),r=new t.Emission(n,"touchmove"),o=t.Promise.race([i,r]);o.when(function(t){e&&(n.emit("panmove",t),t.movementX<0&&n.emit("panleft",t),t.movementX>0&&n.emit("panright",t),t.movementY<0&&n.emit("panup",t),t.movementY>0&&n.emit("pandown",t)),i.resume(),r.resume()})}(),function(){var i=new t.Emission(n,"mouseup"),r=new t.Emission(n,"touchcancel"),o=new t.Emission(n,"touchend"),s=t.Promise.race([i,r,o]);s.when(function(t){n.emit("panend",t),e=!1,i.resume(),r.resume(),o.resume()})}()}return n}();n.Pan=e}(n=t.Recognizer||(t.Recognizer={}))}(Mist||(Mist={}));/**
 * @copyright 2015 AI428
 * @description multi event, style accessor
 * @license http://opensource.org/licenses/MIT
 * @namespace Mist
 */
var Mist;!function(t){var n;!function(n){var e=function(){function n(n){this.emitter=n;var e=new t.Emission(n,"mouseup"),i=new t.Emission(n,"touchend"),r=t.Promise.race([e,i]);r.when(function(t){n.emit("tap",t),e.resume(),i.resume()})}return n}();n.Tap=e}(n=t.Recognizer||(t.Recognizer={}))}(Mist||(Mist={}));/**
 * @copyright 2015 AI428
 * @description multi event, style accessor
 * @license http://opensource.org/licenses/MIT
 * @namespace Mist
