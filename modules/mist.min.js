 ...
 * @namespace Mist
 */
var Mist;!function(t){var n=function(){function t(t){this.statement=t,this.emits={},this.obss={}}return t.customize=function(t,n){void 0===n&&(n={});var e=document.createEvent("CustomEvent");return e.initCustomEvent(t,n.bubbles||!0,n.cancelable||!0,n.detail),e},t.prototype.add=function(t,n){this.obss[t]||(this.obss[t]=[]),this.obss[t].push(n),this.ready(t)},t.prototype.emit=function(t,n){for(var e in this.obss[t])this.obss[t][e](n)},t.prototype.remove=function(t,n){function e(){var t=i.indexOf(n);0>t||i.splice(t,1)}var i=this.obss[t];i&&n?e():i=null},t.prototype.ready=function(t){var n=this,e=this.emits;e[t]||document.addEventListener(t,e[t]=function(e){var i=e.target;i instanceof Element&&i.closest(n.statement.selector())&&n.emit(t,e instanceof CustomEvent?e.detail:e)})},t}();t.Emitter=n}(Mist||(Mist={})),function(t){t.matches=t.matches||t.mozMatchesSelector||t.msMatchesSelector||t.webkitMatchesSelector}(Element.prototype),function(t){t.closest=t.closest||function(t){for(var n=this;n&&!n.matches(t);)n=n.parentElement;return n}}(Element.prototype);/**
 * @copyright 2015 AI428
 * @description statement for CSS in JS
 * @license http://opensource.org/licenses/MIT
 * @namespace Mist
