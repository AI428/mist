 ...
 * @namespace Mist
 */
var Mist;!function(t){var n;!function(t){t[t.A=0]="A",t[t.R=1]="R",t[t.T=2]="T"}(n||(n={}));var e=function(){function e(e){this.statement=e,this.value=new t.Value({}),this.value.when(function(t){var e=[];for(var i in t){var o=t[i];e[o]||(e[o]=[]),e[o].push(i),delete t[i]}this.statement.each(function(t){var i,o=t.classList;!(i=e[n.A])||o.add.apply(o,i),!(i=e[n.R])||o.remove.apply(o,i),!(i=e[n.T])||i.forEach(function(t){o.toggle(t)})})})}return e.prototype.add=function(e,i){var o=this;return void 0===i&&(i=0),new t.Promise(function(r){var s=o.value.compose(function(t){return e.forEach(function(e){t[e]=n.A}),t});i>0?t.Frame.on(o.remove.bind(o,e),i).then(function(t){t.then(r)}):s.then(r)})},e.prototype.remove=function(e,i){var o=this;return void 0===i&&(i=0),new t.Promise(function(r){var s=o.value.compose(function(t){return e.forEach(function(e){t[e]=n.R}),t});i>0?t.Frame.on(o.add.bind(o,e),i).then(function(t){t.then(r)}):s.then(r)})},e.prototype.toggle=function(t){return this.value.compose(function(e){return t.forEach(function(t){switch(e[t]){case n.A:e[t]=n.R;break;case n.R:e[t]=n.A;break;case n.T:delete e[t];break;default:e[t]=n.T}}),e})},e}();t.Class=e}(Mist||(Mist={}));/**
 * @copyright 2015 AI428
 * @description multi event, style accessor
 * @license http://opensource.org/licenses/MIT
 * @namespace Mist
 ...
 * @namespace Mist
 */
var Mist;!function(t){var n;!function(n){var e=function(){function n(n){this.emitter=n;var e=!1;!function(){var i=new t.Emission(n,"mousedown"),o=new t.Emission(n,"touchstart"),r=t.Promise.race([i,o]);r.when(function(t){n.emit("panstart",t),e=!0,i.resume(),o.resume()})}(),function(){var i=new t.Emission(n,"mousemove"),o=new t.Emission(n,"touchmove"),r=t.Promise.race([i,o]);r.when(function(t){e&&(n.emit("panmove",t),t.movementX<0&&n.emit("panleft",t),t.movementX>0&&n.emit("panright",t),t.movementY<0&&n.emit("panup",t),t.movementY>0&&n.emit("pandown",t)),i.resume(),o.resume()})}(),function(){var i=new t.Emission(n,"mouseup"),o=new t.Emission(n,"touchcancel"),r=new t.Emission(n,"touchend"),s=t.Promise.race([i,o,r]);s.when(function(t){n.emit("panend",t),e=!1,i.resume(),o.resume(),r.resume()})}()}return n}();n.Pan=e}(n=t.Recognizer||(t.Recognizer={}))}(Mist||(Mist={}));/**
 * @copyright 2015 AI428
 * @description multi event, style accessor
 * @license http://opensource.org/licenses/MIT
 * @namespace Mist
